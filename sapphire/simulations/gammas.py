...
def max_energy_deposit_in_MIPS(depth, scintillator_depth):
    """Maximum energy transfer from electro to scintillator

    maximum energy transfer of electron to scintillator
    based on remaining scinitillator depth
