...
class Station(object):
    ...
    def __init__(self, cluster, station_id, position, angle, detectors=None,
        ...
        :param detectors: list of tuples.  Each tuple consists of (dx, dy,
            ...
            left-right orientation of the long side of the detector
            respectively.
        :param station_number: optional unique identifier for a station
            this can be used by the cluster to find a specific station
            and makes it easier to link to a real station. If not given
            it will be equal to the station_id.
        ...
        self.angle = angle
        self.station_number = station_number if station_number else station_id
...
class BaseCluster(object):
    ...
    def _add_station(self, position, angle, detectors=None,
        ...
        :param detectors: list of tuples.  Each tuple consists of (dx, dy,
            ...
            respectively.
        :param station_number: optional unique identifier for a station
            this can later be used to find a specific station and makes
            it easier to link to a real station. If not given it will be
            equal to the station_id generated by this function. Either
            use this for all added stations or for none.
    ...
    def get_station(self, station_number):
        ...
        for station in self._stations:
            if station_number == station.station_number:
                return station
...
class RAlphaBetaStations(BaseCluster):
    ...
    def _add_station(self, position, detectors, station_number=None):
        """Add a station to the cluster
