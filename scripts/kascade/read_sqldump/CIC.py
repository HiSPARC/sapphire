...
class CIC(HiSparc2Event):
    ...
    def unpackMessage(self):
        ...
        self.datetime = datetime.datetime(gps_year, gps_month, gps_day, gps_hour, gps_minute, gps_second)
        ...
        (
            ...
            self.mas_npeaks1,
            self.mas_npeaks2,
            self.mas_pulseheight1,
            self.mas_pulseheight2,
            self.mas_int1,
            self.mas_int2,
            mas_tr1,
            mas_tr2,
        ...
        if self.num_devices > 1:
            (
                ...
                self.slv_npeaks1,
                self.slv_npeaks2,
                self.slv_pulseheight1,
                self.slv_pulseheight2,
                self.slv_int1,
                self.slv_int2,
                slv_tr1,
                slv_tr2,
